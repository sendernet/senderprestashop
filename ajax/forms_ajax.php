    ...
    switch (Tools::getValue('action')) {
        case 'saveAllowForms':
            if (Configuration::updateValue(
                $senderprestashop->_optionPrefix . '_allow_forms',
                !Configuration::get($senderprestashop->_optionPrefix . '_allow_forms')
            )) {
                die(Tools::jsonEncode(array(
                    'result' => Configuration::get($senderprestashop->_optionPrefix . '_allow_forms')
                )));
            }
            die(Tools::jsonEncode(array( 'result' => false )));
            break;
        case 'saveFormId':
            if (Configuration::updateValue(
                $senderprestashop->_optionPrefix . '_form_id',
